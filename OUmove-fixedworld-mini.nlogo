        ...
        [
          ...
          [
            ...
            ask patches in-radius floor(crown-diameter / 2) [
              ...
              ;ask tree 3 [ask patch 10 13 [show one-of [affecting-tree] of self ]]
            ]
          ]
        ]
...
to link-trees
  ask trees
  [
    ;get the affecting-trees from the patches in radius
    set neighbor-nodes (turtle-set neighbor-nodes ([affecting-tree] of patches in-radius (crown-diameter / 2)))
